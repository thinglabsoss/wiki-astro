...
import { Aside, Icon ,Tabs, TabItem, Image } from '@astrojs/starlight/components';
...
<Tabs syncKey="system">
  <TabItem label="Windows" icon='seti:windows'>
    ...
    <Aside type='note'>The file path can easily be obtained by holding the shift key, right-clicking the folder, and selecting, **copy as path**.</Aside>
    ...
    <Aside type='caution'>A known issue has been identified regarding compatibility with the adb tool and AMD 5000 series CPUs. AMD has been notified and possibly working on a fix. If you run into this issue, try updating the pc BIOS.</Aside>
