...
- Show information for the Spotify music and podcasts you are playing including the following: Album, Artist, Song Name, Album Art.
...
3.) Enter an app name and description. This can be anything you want.
...
8.) In the settings page, copy the Client ID and Client Secret and save them somewhere you can access them.

### Configuration
After getting your Client ID and Client Secret you are ready to proceed with setting up the Spotify DeskThing App.
...
2.) Scroll down until you locate the Spotify App and select the download Icon. 
...
4.) Within the Request tab you should find an App Request for the Spotify App. 
Enter the Client ID and Client Secret you got earlier 
...
The spotify app has a few navigation and control options you can use to better manage your music.
