...
![DeskThing_Photo](/src/assets/docs/DeskThing_Banner.jpg)
...
## Setting Up
Follow through the following instructions in order to setup your Car Thing with DeskThing.

1.) [Flashing your Car Thing](/first-steps/flashing/).

2.) [Setup ADB](/first-steps/adb/).

3.) [Setup DeskThing Server](/official-apps/deskthing/desktop-server).

4.) [Install Apps](/official-apps/deskthing/managing-apps).
