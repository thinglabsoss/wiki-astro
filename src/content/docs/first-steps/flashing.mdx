...
This page provides step-by-step instructions for flashing the Spotify Car Thing with the Thing Labs OS using the Terbium webpage. Prefer video guides? See the [DeskThing Youtube Channel](https://www.youtube.com/@DeskThing)
...
<Tabs syncKey="system">
  ...
  ### Flashing with Terbium on Windows
    ...
    in a support thread on the [Thing Labs_Discord](https://tl.mt/d).</Aside>
