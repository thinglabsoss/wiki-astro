...
*note: The redirect URL is wrong in this image. It should be "deskthing://a?app=spotify" due to recent spotify API changes.*
...
*Note: the redirect url should be "deskthing://a?app=spotify" instead of localhost due to recent spotify API changes*
